...
experiments = {
    'volume=1e3_disconnection=1e3_MST': constructor_1e3_1e3_MST,
    'volume=1e6_disconnection=1e3_MST': constructor_1e6_1e3_MST,
    'volume=1e3_disconnection=1e6_MST': constructor_1e3_1e6_MST,

    'volume=1e3_disconnection=1e3_NoMST': constructor_1e3_1e3_NoMST,
    'volume=1e6_disconnection=1e3_NoMST': constructor_1e6_1e3_NoMST,
    'volume=1e3_disconnection=1e6_NoMST': constructor_1e3_1e6_NoMST,
}
