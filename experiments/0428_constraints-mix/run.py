...
experiments = {
    'mix_volume=1e3_disconnection=1e3_MST': constructor_1e3_1e3_MST,
    'mix_volume=1e6_disconnection=1e3_MST': constructor_1e6_1e3_MST,
    'mix_volume=1e3_disconnection=1e6_MST': constructor_1e3_1e6_MST,
    'mix_volume=1e3_disconnection=1e3_NoMST': constructor_1e3_1e3_NoMST,
    'mix_volume=1e6_disconnection=1e3_NoMST': constructor_1e6_1e3_NoMST,
    'mix_volume=1e3_disconnection=1e6_NoMST': constructor_1e3_1e6_NoMST,
}
